...
|--------------------|------------------------------------|----------------------------------------|
|Usuário do sistema  | Encontrar uma oportunidade de emprego | Estabilidade e segurança |
|Administrador       | Criar um curriculo e meio de contato | Encontrar um emprego compativel|
